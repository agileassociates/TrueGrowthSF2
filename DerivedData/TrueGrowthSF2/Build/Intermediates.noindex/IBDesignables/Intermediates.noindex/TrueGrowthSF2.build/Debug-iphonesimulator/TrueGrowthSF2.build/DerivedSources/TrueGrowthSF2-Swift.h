...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TrueGrowthSF2",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13TrueGrowthSF217CurrencyTextField")
...
SWIFT_CLASS("_TtC13TrueGrowthSF224EmailLoginViewController")
...
SWIFT_CLASS("_TtC13TrueGrowthSF214FacebookButton")
...
- (IBAction)logInWithEmailBtnPressed:(id _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC13TrueGrowthSF211RoundUIView")
...
SWIFT_CLASS("_TtC13TrueGrowthSF217RoundedCornerView")
